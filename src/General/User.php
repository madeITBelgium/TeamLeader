...
class User
{
    ...
    public function me()
    {
        return $this->teamleader->getCall('users.me');
    }
    ...
    {
        return $this->teamleader->getCall('users.list?'.http_build_query($data));
    }
    ...
    {
        return $this->teamleader->getCall('users.info?'.http_build_query(['id' => $id]));
    }
}
